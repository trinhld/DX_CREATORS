...
!(function (a) {
  ...
  (d.prototype = {
    ...
    enable: function () {
      this.enabled ||
        (this.$element.is('input') && (this.$element.on('keyup', a.proxy(this.update, this)), this.defaults.trigger || this.$element.on('focus', a.proxy(this.show, this))),
    ...
    disable: function () {
      this.enabled &&
        (this.$element.is('input') && (this.$element.off('keyup', this.update), this.defaults.trigger || this.$element.off('focus', this.show)),
    ...
    template: function (b) {
      ...
      return (
        ...
        [
          ...
          c.selected ? 'class="' + this.defaults.selectedClass + '"' : c.disabled ? 'class="' + this.defaults.disabledClass + '"' : '',
    ...
    fillMonths: function () {
      ...
      for (c = h.toString() + this.defaults.yearSuffix || '', b = 0; 12 > b; b++)
        (a = h === f && b === g),
          d.push(
            this.template({
              text: e[b],
    ...
    fillWeek: function () {
      ...
      for (d = a.merge(d.slice(e), d.slice(0, e)), b = 0; 7 > b; b++)
        c.push(
          this.template({
            text: d[b],
          }),
    ...
    fillDays: function () {
      ...
      for (i = this.defaults.showMonthAfterYear ? s + o + ' ' + n[t] : n[t] + ' ' + s + o, e = 0 === t ? d.fn.getDaysInMonth(s - 1, 11) : d.fn.getDaysInMonth(s, t - 1), g = 1; e >= g; g++)
        k.push(
          this.template({
            text: g,
            type: 'day prev',
      ...
      for (f = new Date(s, t, 1, 0, 0, 0, 0), h = (7 + (f.getDay() - u)) % 7, h = h > 0 ? h : 7, k = k.slice(e - h), e = 11 === t ? d.fn.getDaysInMonth(s + 1, 0) : d.fn.getDaysInMonth(s, t + 1), g = 1; e >= g; g++)
        m.push(
          this.template({
            text: g,
            type: 'day next',
      ...
      for (e = d.fn.getDaysInMonth(s, t), f = new Date(s, t, e, 0, 0, 0, 0), h = (7 - (f.getDay() + 1 - u)) % 7, h = h >= 42 - (k.length + e) ? h : h + 7, m = m.slice(0, h), g = 1; e >= g; g++)
        (b = s === p && t === q && g === r),
    ...
    click: function (b) {
      var c,
        ...
        i = /^\d{2,4}$/,
        j = !1;
      if ((b.stopPropagation(), b.preventDefault(), 0 !== h.length))
        switch (((c = this.viewDate.getFullYear()), (d = this.viewDate.getMonth()), (e = this.viewDate.getDate()), (g = h.data().type))) {
          case 'years prev':
          case 'years next':
            (c = 'years prev' === g ? c - 10 : c + 10),
              (f = h.text()),
              (j = i.test(f)),
              j && ((c = parseInt(f, 10)), (this.date = new Date(c, d, Math.min(e, 28), 0, 0, 0, 0))),
              (this.viewDate = new Date(c, d, Math.min(e, 28), 0, 0, 0, 0)),
              this.fillYears(),
              j && (this.showView(1), this.output());
            break;
          case 'year prev':
          case 'year next':
    ...
    (d.fn = {
      ...
      parseDate: function (a, b) {
        ...
        if (((c = 'string' == typeof a && a.length > 0 ? a.split(b.separator) : []), (d = b.parts.length), (a = new Date()), (e = a.getFullYear()), (f = a.getDate()), (g = a.getMonth()), c.length === d))
          for (i = 0; d > i; i++)
            switch (((h = parseInt(c[i], 10) || 1), b.parts[i])) {
              case 'dd':
              case 'd':
                f = h;
                break;
